...
void main(){
  ...
  printf("Dame el nombre y el tipo de cara del jugador 1\n");
  scanf("%[^\n]%*c",&frase1);
  printf("Dame el numero de lanzamientos\n");
  scanf("%d%*c",&cantidad);
  int numeros[cantidad];
  printf("Dame los numeros caidos\n");
  for(int x=0;x<cantidad;x++){
    scanf("%d",&numeros[x]);
  }
  scanf("%*c");
  printf("Dame el nombre y el tipo de cara del jugador \n");
  scanf("%[^\n]%*c",&frase2);
  printf("Dame el numero de lanzamientos\n");
  scanf("%d",&cantidad2);
